-- V218: refresh and validate public-business-table audit trigger coverage.
--
-- Repeats the full fail-closed coverage sweep after V203–V215 added business tables
-- (rd_tasks@V204, rd_task_forwarders@V211, hr_task_claims@V213, employee_phones@V214,
--  employee_vehicles@V214, task_claims@V215). V169/V184/V185/V190/V193/V195/V197/V202
...
-- here record only future operations from V218 application onward; this migration never
