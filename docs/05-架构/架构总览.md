...
开发原库 `uten_imp` 2026-08-10 已确认到 V244/225；截至 2026-08-14，共享工作树源码目录最高 V289/270，270 个版本号无重复。V288/V289 已建立现货借用结构、终态守卫与审计覆盖，在线 create/revoke、持久化、双趟生效计算和 Flutter UI 已形成源码候选。V253/234 与空库 V252/233 是 2026-08-11 阶段快照，一次性生产物料克隆仍是 V250/231 历史证据，公司目标库仍以 V238 既有只读证据为准。V257–V289 均未建立第二份生产默认车间；唯一真源仍是 V192 `production_goods_workshop_preferences`。目标库迁移、真实权限/岗位/实物 UAT、完整 HTTP IQC/QMS 和发布签字仍未完成，生产 **NO-GO**。
