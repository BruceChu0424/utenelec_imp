...
//
// 设计原则：
// - expanded 断点（>=840）：Row -> 左 [UtenFilterPane] 侧栏（宽 siderWidth）
//   + 右 [Expanded] 表格区，筛选常驻可见、表格顶满剩余宽。
...
class UtenListTwoPane extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // expanded: 侧栏（UtenFilterPane 包裹 filterPane）+ 表格顶满剩余宽
    return Row(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        SizedBox(
          width: siderWidth,
          child: UtenFilterPane(
