-- V396: full future-write audit sweep after customer access and employee handover tables.
DO $$
DECLARE
    r RECORD;
...
BEGIN
  ...
  LOOP
    ...
    IF prefixed_trigger_count = 1 AND valid_trigger_count = 1
    ...
    IF prefixed_trigger_count > 0 THEN RAISE EXCEPTION
      ...
      r.relname, prefixed_trigger_count, valid_trigger_count
