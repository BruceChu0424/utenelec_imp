...
//
// UI：筛选区（单据类型分段与搜索同处一条 UtenFilterToolbar + 日期范围）
...
class _SalesReportPageState extends ConsumerState<SalesReportPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // 返回即刷新：行点击 push 的销售单据详情里审核/取消/红冲后返回，重拉报表。
    _myLocation ??= currentLocationOr(context, SalesRoutePath.hub);
      ...
      child: Column(
        ...
        children: [
          ...
          UtenFilterToolbar<SalesReportDocType>(
            ...
            searchHint: _kind.isDetail ? '搜索单号 / 货品 / 客户' : '搜索客户 / 单号',
