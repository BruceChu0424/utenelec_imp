-- V321: full audit sweep after central override provenance hardening.
--
-- V319 adds provenance columns to an audited authorization table; rerun the
-- identifier-safe public-table sweep and retain the fail-closed repair path.
