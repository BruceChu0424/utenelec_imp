...
## 十一、2026-07-31 人员概况卡可收起并下移

- 人员概况卡移至**部门详情卡（MasterDetailCard）下方**、员工工具栏上方。
- 卡片**可收起/展开**（点标题行，chevron 旋转指示），**默认收起**；收起状态只显示「当前人员」一组指标（在册/正式/试用/休假/直属/下级部门），展开后才是人员流动、到期提醒与数据质量说明。
