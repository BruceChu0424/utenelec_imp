...
> 源码：[`uten_picker_confirm_bar.dart`](../../lib/components/layout/uten_picker_confirm_bar.dart) · 视觉基座：[UtenBottomActionBar](UtenBottomActionBar.md) · 最后核对：2026-08-16。
