...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get employeeOnboardNote => 'Submitting creates a login account (employee code as username) and a high-entropy one-time password. It must be changed at first sign-in.';
