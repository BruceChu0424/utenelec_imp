-- V195: refresh and validate public-business-table audit trigger coverage.
--
-- V169, V184, V185, V190, and V193 remain immutable once applied.
-- This migration repeats the full fail-closed coverage sweep after V194 added
-- the MAKE finished-in receipt-allocation business ledger.
