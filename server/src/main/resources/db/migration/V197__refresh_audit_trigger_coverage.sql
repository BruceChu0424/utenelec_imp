-- V197: refresh and validate public-business-table audit trigger coverage.
--
-- V169, V184, V185, V190, V193, and V195 remain immutable once applied.
-- This migration repeats the full fail-closed coverage sweep after V196 added
-- the procurement approval and expected-inbound ledgers.
...
-- operations from V195 application onward; this migration never invents or
