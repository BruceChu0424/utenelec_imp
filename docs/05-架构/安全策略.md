...
**最后更新**：2026-08-22（§4.6 更新为 ADR-045 / V315–V329 页面内权限转授现行契约；部门默认空、普通根覆盖子树、总经办负责人覆盖公司，默认开启且可显式 `false` 紧急回退，仍未部署）/ 2026-08-14（共享工作树目录 V289/270、270 个版本号无重复；V279–V289 均为源码候选，V288/V289 借用在线链已接通但未部署；公司目标库仍为 V238 既有证据，未替代权限/岗位 UAT 或发布）/ 2026-08-10（V247–V250 生产分析/执行快照/来源谱系、订货财务 PENDING 临时详情范围及
