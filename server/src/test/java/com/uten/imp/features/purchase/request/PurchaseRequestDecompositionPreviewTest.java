...
class PurchaseRequestDecompositionPreviewTest {
    ...
    void previewDeduplicatesAndSortsIdsAndSubtractsPendingFinanceOccupancy() {
        ...
        assertThat(result.get(1).pendingQty()).isEqualByComparingTo("3");
        assertThat(result.get(1).remainingQty()).isEqualByComparingTo("5");
    ...
    private static Object[] row(
            ...
            String sourcePlanNo) {
        return new Object[]{
                requestId, requestNo, itemId, goodsId, null, unitId,
