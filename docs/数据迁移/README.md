...
| 说明 | 迁移 | 本次变化 |
| --- | --- | --- |
| [238](238-V703至V706计划超产比例与历史迁移恢复.md) | V703–V706 | 计划及下达初始比例、追加反向/提前完结保护；恢复 V694/V700/V701 的真实已应用原件，并前向补齐后续变更 |
