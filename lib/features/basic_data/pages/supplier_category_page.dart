...
class _DetailPaneState extends State<_DetailPane> {
  ...
  void _onFilterChanged(String key, String? value) {
    // 业务员列（ownerEmployeeName）在服务端的筛选参数是 ownerEmployeeId（桶值=员工 UUID）。
  ...
  /// 表头筛选桶/空值计数：服务端 empId 桶（值=业务员 UUID、label=人名）remap 到
  /// 业务员列 key ownerEmployeeName（表格按列 key 索引 facets）。
