-- V193: refresh and validate public-business-table audit trigger coverage.
--
-- V169, V184, V185, and V190 may already be applied and remain immutable.
-- This migration repeats the full fail-closed coverage sweep after the V191
-- planning-draft and V192 workshop-preference business tables were added.
...
-- operations from V193 application onward; this migration never invents or
