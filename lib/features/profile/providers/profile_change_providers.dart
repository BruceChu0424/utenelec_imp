...
final myProfileChangesProvider = FutureProvider.autoDispose.family<
    ProfileChangePage<MyProfileChangeListItem>,
    ({String? status, int page})>((ref, key) {
  return ref
...
final hrProfileChangesProvider = FutureProvider.autoDispose.family<
