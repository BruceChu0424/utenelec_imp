...
CREATE TEMP TABLE receipt_stage (
    ...
    tax_rate numeric(18,4), total_original numeric(18,4), status smallint,
    cancel_bit boolean, remark text);
...
INSERT INTO subcontract_receipt_items (
    ...
    returned_qty, weight, source_doc_no)
SELECT s.legacy_id, a.bill_no, a.bill_date,
...
INSERT INTO subcontract_material_return_items (
    ...
    parent_color_id, weight, source_doc_no)
SELECT s.legacy_id, a.bill_no, a.bill_date,
