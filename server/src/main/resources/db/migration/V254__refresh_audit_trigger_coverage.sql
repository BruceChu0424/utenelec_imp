-- V254: refresh audit trigger coverage after V253 added website inquiries.
--
-- website_inquiries is a business inbox and conversion ledger. V253 installs its
-- trigger explicitly; this fail-closed full sweep also verifies that trigger and
-- every other public business table. It does not backfill historical audit rows.
