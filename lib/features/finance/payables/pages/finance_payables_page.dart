...
class _FinancePayablesPageState extends ConsumerState<FinancePayablesPage> {
                ...
                if (_workspace == _PayablesWorkspaceView.payables &&
                  ...
                  if (selectedPrepayment)
                    Padding(
                      ...
                      child: Semantics(
                        label: '供应商预付款需专用预付款资产和总账链，不可在此应用',
                        child: Text(
        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                _choice('全部', _businessType == null, () {
                  _changeFilter(() => _businessType = null);
                }),
                _choice('采购', _businessType == 'PURCHASE', () {
                  _changeFilter(() => _businessType = 'PURCHASE');
                }),
                _choice('委外', _businessType == 'SUBCONTRACT', () {
                  _changeFilter(() => _businessType = 'SUBCONTRACT');
                }),
              ],
            ),
            const SizedBox(height: UtenSpacing.s12),
            ...
            Wrap(
              ...
              runSpacing: UtenSpacing.s4,
              children: [
                _statusChoice('全部', null),
                _statusChoice('未付', 'OPEN'),
                _statusChoice('部分', 'PARTIAL'),
                _statusChoice('已结清', 'SETTLED'),
                _statusChoice('逾期', 'OVERDUE'),
                _statusChoice('贷项', 'CREDIT'),
              ],
            ),
            const SizedBox(height: UtenSpacing.s12),
            _dateRange(
              ...
              from: _dateFrom,
              to: _dateTo,
              onChanged: (from, to) => _changeFilter(() {
                _dateFrom = from;
                _dateTo = to;
              }),
            ),
  ...
  Widget _statusChoice(String label, String? value) => _choice(
    label,
    _status == value,
