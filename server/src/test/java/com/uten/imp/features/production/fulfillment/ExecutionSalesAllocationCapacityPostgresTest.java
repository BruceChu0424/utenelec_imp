...
class ExecutionSalesAllocationCapacityPostgresTest {
    ...
    @BeforeAll static void start() throws Exception {
        ...
        try(var c=connection()) {
            ...
            sql(c,"CREATE TABLE production_execution_segments(id uuid PRIMARY KEY,source_plan_item_id uuid NOT NULL,planned_qty numeric(18,4) NOT NULL,status text NOT NULL,package_id uuid NOT NULL REFERENCES production_planning_packages(id),is_deleted boolean NOT NULL DEFAULT false,responsible_employee_id uuid, allowed_overproduction_rate numeric(9,6) NOT NULL DEFAULT 0.10, material_discovery_required boolean NOT NULL DEFAULT FALSE, overproduction_rate_version bigint NOT NULL DEFAULT 0, route_defaulted_at timestamptz)");
