-- =====================================================================
-- 本地/测试库业务数据一键清空（支持至 V539；保留主档、人事、权限与治理证据）
-- =====================================================================
...
--
-- 唯一范围事实：
--   · V539 当前目录：CLEAR 266 张、PRESERVE 96 张；下列历史说明用于旧版本兼容。
