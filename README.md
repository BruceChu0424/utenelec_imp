...
| 项目 | 当前值 |
|---|---|
| 当前版本 | 服务器 **v2.0.1**(库 V688, 2026-09-24 部署); main 已含 V689-V691, 下一版 v2.0.2 |
| 数据库迁移头 | **V691** / 620 个迁移文件(V648-V669 跳号); 新迁移从 V692 起, 新 ADR 从 ADR-115 起 |
...
- 新迁移号必须大于当前迁移头(main 在 V691, 服务器在 V688; 更小的号会被 Flyway 判为乱序拒绝启动)。开号前先查目录与在途分支, 避免撞号。
