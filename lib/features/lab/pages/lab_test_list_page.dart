      ...
      children: [
        ...
        Padding(
          ...
          child: UtenSegmentedFilter<LabFilter>(
            selected: filter,
            onChanged: (v) => ref.read(labFilterProvider.notifier).state = v,
            segments: const [
            ...
            data: (list) {
              if (list.isEmpty) {
                return ListView(
                  children: const [
                    SizedBox(height: 80),
                    UtenEmpty(icon: Icons.science_outlined, message: '暂无检测记录'),
                  ],
                );
              }
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(
                '${test.testDate.month}-${test.testDate.day}',
                style: theme.textTheme.bodySmall?.copyWith(
                  color: theme.colorScheme.onSurfaceVariant,
                ),
              ),
