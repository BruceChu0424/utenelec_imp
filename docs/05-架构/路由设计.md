...
- 开发原库 `uten_imp` 2026-08-10 已确认到 V244/225，当前源码到 V252/233（V251 货品导入，V252 审计覆盖），一次性生产物料克隆仍是 V250/231 历史证据，公司目标库仍以 V238 既有只读证据为准；但路由与迁移存在不等于真实账号、岗位、实物和生产验收完成。
