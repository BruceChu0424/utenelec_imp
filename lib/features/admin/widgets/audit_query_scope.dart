      ...
      child: Column(
        ...
        children: [
          ...
          if (requestInvestigation)
            Container(
              ...
              child: Row(
                children: [
                  ...
                  TextButton(onPressed: onClear, child: const Text('返回选人')),
                ],
              ),
            )
          else ...[
            ...
            Align(
              ...
              child: FilledButton.icon(
                ...
                onPressed: !hasActorScope || range == null || loading
                    ? null
                    : onRunQuery,
          ...
          ExpansionTile(
            ...
            title: const Text('按操作关联编号精确排查'),
            subtitle: const Text('仅在调查某一次操作时使用'),
            children: [
              Semantics(
