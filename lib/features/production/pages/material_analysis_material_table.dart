...
abstract class _MaterialAnalysisMaterialTableState
  ...
  ProductionMaterialAnalysisProduct? _tableMakeAnchorOf(_MaterialGroup group) {
    final analysis = _analysis;
    ...
    final previewed = _tableCascadePreview?.products
  ...
  /// 「有一部分没有成功下单」的其中一处)。
  double? _tableAnchorResidual(ProductionMaterialAnalysisMaterial material) {
    final analysis = _analysis;
    if (analysis == null) return null;
