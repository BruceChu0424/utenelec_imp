-- V316: refresh the fail-closed full public audit-trigger sweep after V315.
--
-- V315 creates manager_permission_delegations with an explicit audit trigger.
-- Re-run the shared sweep so every public business table still has exactly one
-- valid enabled AFTER ROW INSERT/UPDATE/DELETE audit trigger.
