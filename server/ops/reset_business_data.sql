-- =====================================================================
-- 本地/测试库业务数据一键清空(支持至 V640；保留主档、人事、权限与治理证据)
-- =====================================================================
...
BEGIN
    ...
    IF (applied_max_version, applied_migration_count) NOT IN (
        ...
        (640, 592),
        -- V644 审核生产日报的幂等键: 命令账本加 command_kind 一列并把 UNIQUE(report_id) 换成 (report_id, command_kind), 不加表; V641-V643 跳号, 本迁移 592→593。
        (644, 593)
    ) THEN
        RAISE EXCEPTION
            '仅允许 V443/405、V446/408、V447/409、V448/410、V449/411、V450/412、V451/413、V452/414、V453/415、V454/416、V455/417、V456/418、V457/419、V458/420、V459/421、V460/422、V461/423、V462/424、V463/425、V464/426、V465/427、V466/428、V467/429、V468/430、V469/431、V470/432、V471/433、V472/434、V473/435、V474/436、V475/437 、V476/438、V477/439、V478/440、V479/441、V480/442、V481/443、V482/444、V483/445、V484/446、V485/447、V486/448、V487/449、V488/450、V489/451、V490/452、V491/453、V492/454、V493/455、V494/456、V495/457、V496/458、V497/459、V498/460、V499/461、V500/462、V501/463、V502/464、V503/465、V504/466、V505/467、V506/468、V507/469、V508/470及V511至V644完整目录(V544、V576、V604、V633、V635、V637、V639、V641、V642、V643 跳号)，当前 V%/%',
