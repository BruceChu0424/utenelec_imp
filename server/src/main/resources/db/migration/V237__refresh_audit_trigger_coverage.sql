-- V237: refresh and validate public-business-table audit trigger coverage.
--
-- Repeats the fail-closed coverage sweep after V234 added production material-analysis
-- business tables and V236 added receivable-settlement metadata. Earlier applied
-- migrations remain immutable. Triggers created here record only future operations
-- from V237 onward; this migration never invents or backfills historical audit rows.
