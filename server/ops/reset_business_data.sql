-- =====================================================================
-- 本地/测试库业务数据一键清空(支持至 V693；保留主档、人事、权限与治理证据)
-- =====================================================================
...
('users', 'PRESERVE'),
-- V693 仓库负责人(ADR-115)：仓库的附属设置，随仓库/员工主档保留。
