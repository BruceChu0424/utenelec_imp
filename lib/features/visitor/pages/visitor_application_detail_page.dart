      ...
      appBar: UtenAppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () =>
                ref.invalidate(visitorApplicationDetailProvider(applicationId)),
          ),
        ],
      ),
      body: detail.when(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (app.status == VisitorApplicationStatus.approved &&
                      app.qrToken != null &&
                      app.qrToken!.isNotEmpty) ...[
                    UtenCard(
                      padding: const EdgeInsets.all(UtenSpacing.s20),
                      child: Column(
                        children: [
                          UtenSectionHeader(
                            title: l10n.visitorDetailQr,
                          ...
                          Text(
                            l10n.visitorDetailQrHint,
                            style: Theme.of(context).textTheme.bodySmall,
                            textAlign: TextAlign.center,
                          ),
                          const SizedBox(height: UtenSpacing.s16),
                          Text(
                            l10n.visitorPasscodeLabel,
                            style: Theme.of(context).textTheme.bodySmall,
                          ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (app.approvedAt != null)
                          UtenInfoRow(
                            label: l10n.visitorDetailApprovedAt,
                            value: fmtDateTime(app.approvedAt!),
                          ),
                        if (app.rejectReason != null &&
                            app.rejectReason!.isNotEmpty)
                          UtenInfoRow(
                            label: l10n.visitorDetailRejectReason,
                  ...
                  if (d.steps.isNotEmpty) ...[
                    ...
                    UtenCard(
                      child: Column(
                        ...
                        children: [
                          UtenSectionHeader(
                            title: l10n.visitorDetailTimeline,
