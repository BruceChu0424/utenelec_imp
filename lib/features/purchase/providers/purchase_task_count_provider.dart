...
//
// 口径 = 采购任务中心未完成任务数（UNPEGGED 待采购处理 + WAITING_SUPPLY 申请/订单/收货中），
// 后端 GET /operations/workbench/purchase/count 返回 {count}，与采购任务中心同源。
...
/// 采购任务中心待办任务数（UNPEGGED + WAITING_SUPPLY 行数）。
///
