-- V202: refresh and validate public-business-table audit trigger coverage.
--
-- V169, V184, V185, V190, V193, V195, and V197 remain immutable once applied.
-- This migration repeats the full fail-closed coverage sweep after V201 added
-- the procurement arrival-exception, supplier-return, and event ledgers.
-- It also protects against any earlier business table being silently unaudited.
...
-- operations from V202 application onward; this migration never invents or
