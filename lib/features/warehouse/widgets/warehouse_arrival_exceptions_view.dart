// 到货异常任务中心（可嵌入）：财务定案后仓库按批准量一键入库 / 退回归档。
//
...
class WarehouseArrivalExceptionsView extends ConsumerStatefulWidget {
  ...
  ConsumerState<WarehouseArrivalExceptionsView> createState() =>
      _WarehouseArrivalExceptionsViewState();
}

class _WarehouseArrivalExceptionsViewState
    extends ConsumerState<WarehouseArrivalExceptionsView> {
  ...
  @override
  void didUpdateWidget(WarehouseArrivalExceptionsView oldWidget) {
      ...
      children: [
        Semantics(
          ...
          child: UtenFilterToolbar<bool>(
            ...
            searchHint: widget.embedded ? null : '搜索收货单 / 订货单 / 货品 / 供应商',
