-- V325: full audit sweep after contextual authority generations and explicit
-- organization-leader assignments.
--
-- V322-V324 add authorization snapshots, the explicit assignment business
-- table, and forward lock-order fixes. Re-run the identifier-safe public-table
-- sweep so every business-bearing row remains auditable.
