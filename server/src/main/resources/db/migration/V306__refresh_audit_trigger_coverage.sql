-- V306: refresh the fail-closed full public audit-trigger sweep after V304.
--
-- V304 creates two business-bearing subcontract material-plan tables and attaches
-- explicit audit triggers. Re-run the shared sweep so the repository contract also
