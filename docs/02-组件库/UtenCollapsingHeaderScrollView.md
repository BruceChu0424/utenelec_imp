...
**何时用**：页面是「上方有一块固定顶部（卡 / 统计 / 工具条）+ 下方 `Expanded(MasterDataTableView)`」的结构，顶部又较高、挤压了表格（如货品 / 模具 / 客户 / 供应商 分类详情页）。
...
**最后更新**：2026-08-14 · 新增组件。货品 / 模具 / 客户 / 供应商 四个分类详情页接入（卡片折叠 + 搜索行吸顶 + 表格内滚）。扁平主档页（颜色 / 单位 / 仓库 / 币种 / 账户）顶部仅一行搜索条、本就吸顶，不接入。
