...
| 项目 | 当前值 |
|---|---|
| 当前版本 | **v2.0.1**(2026-09-24 已部署到公司内网测试服务器) |
| 数据库迁移头 | **V688** / 617 个迁移文件(V648-V669 跳号) |
...
**接手先读**: [全平台整改交接总览](docs/99-项目治理/全平台整改交接/01-交接总览.md)(现在在做什么、做完什么、下一步怎么做) → [准则索引与开发清单](docs/00-项目准则/00-准则索引与开发清单.md) → [文档索引](docs/README.md)。
...
- 新迁移号必须大于当前迁移头(服务器已在 V688, 更小的号会被 Flyway 判为乱序拒绝启动)。开号前先查目录与在途分支, 避免撞号。
