-- =====================================================================
-- V464：business_data_reset() 双胞胎同步——补 V463 两张订货行来源表
-- =====================================================================
-- V463 新增 purchase_order_item_sources / subcontract_order_item_sources
-- 两张业务表后，清空函数的「未分类 public 表拒绝」会失败关闭。本迁移
-- 原样重发 V462 的 business_data_reset()，仅把两张新表登记为 CLEAR
-- （320 表：CLEAR 224 / PRESERVE 96）。V462 文件保持不动（历史已应用）。
